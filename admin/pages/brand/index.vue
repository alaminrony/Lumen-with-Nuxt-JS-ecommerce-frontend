        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              ...
              <BrandFilter @Filtering="handleFiltering" @createBrand="createBrand"></BrandFilter>
            </div>
            <div class="col-md-12">
              <!-- DATA TABLE-->
              <div class="table-responsive m-b-40">
                <table class="table table-borderless table-data3">
                  ...
                  <tbody v-if="brandList.data">
                    <BrandRow  v-for="brand of brandList.data" :brand="brand" :key="brand.id" @removeBrand="removeBrand" @editBrand="editBrand"></BrandRow>
                  </tbody>
                </table>
              </div>
